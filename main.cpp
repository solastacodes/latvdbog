...
void loadDemo(VectorDB& db) {
    ...
    db.insert("Tacos: corn tortilla beans avocado salsa cilantro", "food",
        {0.08f,0.06f,0.09f,0.07f,0.07f,0.08f,0.06f,0.09f,0.88f,0.85f,0.80f,0.78f,0.08f,0.06f,0.09f,0.07f}, dist);
